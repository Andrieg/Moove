        ...
        <main className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <label className="flex items-center gap-3 mb-6 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 rounded-md border-slate-300 text-[#308FAB] focus:ring-[#308FAB] cursor-pointer"
                  />
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                <p className="text-sm text-slate-500">
                  ...
                  <Link href="/client/register" className="text-[#308FAB] font-semibold hover:underline">Sign Up</Link>
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-500">
                Are you a coach?{" "}
                <Link href="/coach/login" className="text-[#308FAB] font-semibold hover:underline">Sign in here</Link>
              </p>
            </div>
          </div>
        </main>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100 text-center">
            ...
            <p className="mt-6 text-sm text-slate-400">
              Didn&apos;t receive it?{" "}
              <button onClick={() => setStep("login")} className="text-[#308FAB] font-medium hover:underline">
                Try again
              </button>
            </p>
          </div>
