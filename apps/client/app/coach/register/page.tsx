          ...
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
              <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-slate-900 mb-2">Become a Coach</h1>
                <p className="text-slate-500 text-sm">Start building your fitness empire</p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                <p className="text-sm text-slate-500">
                  ...
                  <Link href="/coach/login" className="text-[#308FAB] font-semibold hover:underline">Sign in</Link>
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-slate-500">
                Looking to train?{" "}
                <Link href="/client/register" className="text-[#308FAB] font-semibold hover:underline">Join as a member</Link>
              </p>
            </div>
          </div>
        </main>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100 text-center">
            ...
            <p className="text-slate-500 mb-8">We&apos;ve sent a verification link to <span className="font-medium text-slate-700">{email}</span></p>
