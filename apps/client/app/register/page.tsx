...
function RegisterForm() {
  ...
  const isCoachRegistration = searchParams.get("type") === "coach";
  ...
  // Step 2: Handle "OK" click (simulate clicking magic link)
  const handleLinkSentOk = () => {
    // In real implementation, user would click email link
    // For dev, we skip directly to profile setup
    setStep("profile");
  };
  ...
  const handleProfileSave = async (e: React.FormEvent) => {
    ...
    if (isCoachRegistration && !profileData.brandName) {
    ...
    showToast(
      "success",
      `Welcome, ${profileData.firstName}! Your ${isCoachRegistration ? "coach " : ""}account has been created.`
    );
          ...
          <div className="w-full max-w-sm">
            <div className="bg-white rounded-2xl p-8">
              ...
              <form onSubmit={handleEmailSubmit}>
                ...
                <label className="flex items-start gap-3 mb-6 cursor-pointer">
                  ...
                  <span className="text-xs text-gray-500 leading-relaxed">
                    ...
                    <Link href="#" className="text-[#308FAB] font-medium">
                      Terms & Conditions
                    </Link>{" "}
                    and{" "}
                    <Link href="#" className="text-[#308FAB] font-medium">
              ...
              <p className="text-center text-xs text-gray-400 mt-6">
                ...
                <Link href="/login" className="text-[#308FAB] font-medium">
                  Sign in
                </Link>
              </p>
            </div>
  ...
  // Screen 3: Profile Setup (Let's get to know you)
  return (
    <div className="min-h-screen bg-black flex flex-col">
      <header className="p-6">
        <Image src="/images/logo.svg" alt="Moove" width={100} height={32} className="invert" />
