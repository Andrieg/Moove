...
export default function EditVideoPage({ params }: PageProps) {
    ...
    try {
      ...
      if (video) {
        setFormData({
          ...
          target: (video as any).target || "full-body",
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await updateVideo(videoData, Object.keys(formData));
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  type="number"
                  value={Math.floor(formData.durationSeconds / 60)}
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-xs mt-1 ml-8">
                {formData.published ? "Video is visible to members" : "Video is saved as draft"}
              </p>
            </div>
